...
get the app created:
    ...
    $ heroku apps:create herokutesting
    Creating herokutesting... done, stack is cedar
    http://herokutesting.herokuapp.com/ | git@heroku.com:herokutesting.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://herokutesting.herokuapp.com deployed to Heroku

    To git@heroku.com:herokutesting.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://herokutesting.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@herokutesting.herokuapp.com/repl
